 ...
 */
const InvoiceActions = ({ saleId, invoiceNumber }) => {
  ...
  const handleViewInvoice = async () => {
    try {
      ...
      const response = await api.get(`/api/sales/${saleId}/invoice`);
  ...
  const handleSendEmail = async () => {
    ...
    try {
      ...
      const response = await api.post(`/api/sales/${saleId}/email-invoice`, { email });
